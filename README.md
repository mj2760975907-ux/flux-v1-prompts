...
- Creating various art styles (e.g., photorealistic, abstract, cartoonish)
- Rendering specific objects, characters, and scenes
- Applying artistic techniques (e.g., watercolor, oil painting, digital art)
- Producing high-resolution images

--- ## ⚠️ Limitations

- May struggle with complex or abstract concepts
- Can sometimes misinterpret the relationships between objects in a scene
- Output quality is heavily dependent on prompt clarity and detail
- Potential for bias in generated images due to training data
...
high-quality prompts, complete with visual examples and detailed instructions.
  ...
  ###
  Product ultra-realistic CGI footage
    ![Product ultra-realistic CGI footage](https://img.opennana.com/prompts/images/321.jpeg)
  ...
  ```
  ###
  Studio photos of products
    ![Studio photos of products](https://img.opennana.com/prompts/images/322.jpeg)
  ...
  ###
  Character creation
    ![Character creation](https://img.opennana.com/prompts/images/323.jpeg)
  ...
  ###
  pop art portrait
    ![pop art portrait](https://img.opennana.com/prompts/images/324.jpeg)
  ...
  beauty fashion photography
    ![beauty fashion photography](https://img.opennana.com/prompts/images/325.jpeg)
  ...
  ```
  ###
  Cinematic street beauty photography
    ![Cinematic street beauty photography](https://img.opennana.com/prompts/images/326.jpeg)
  ...
  ```
  ###
  Beauty movie style portrait
    ![Beauty movie style portrait](https://img.opennana.com/prompts/images/327.jpeg)
...
Style: hyper-realistic, luxury portrait, magazine aesthetic.
  ```
  ###
  Studio portrait style photos
    ![Studio portrait style photos](https://img.opennana.com/prompts/images/328.jpeg)

  ```markdown
  Referring to the facial features in Figure 1, a full-body studio portrait is generated: a handsome young East Asian woman is sitting on the floor in front of a light purple background, wearing a comfortable oversized lavender thick knitted sweater, a white skirt and white socks, affectionately holding a large Sanrio Kurome plush toy, and looking tenderly at the camera. The background is decorated with playful hand-drawn purple doodles and text including "A", "ANNISA", paper airplanes and flowers, styled like a K-pop photo card or fan magazine cover. The light is bright and soft, creating a lovely and warm atmosphere.
  ```
  ###
  Vertical portrait of beautiful woman
    ![Vertical portrait of beautiful woman](https://img.opennana.com/prompts/images/329.jpeg)
  ...
  Photorealistic indoor lying portraits
    ![Photorealistic indoor lying portraits](https://img.opennana.com/prompts/images/330.jpeg)
...
"photorealistic_indoor_reclining_portrait",
  ...
  ###
  women in corridor
    ![women in corridor](https://img.opennana.com/prompts/images/331.jpeg)
  ...
  ###
  Girls mirror selfie
    ![Girls mirror selfie](https://img.opennana.com/prompts/images/332.jpeg)
...
* Fake portrait mode blur, CGI/illustration look
  ...
  Girl sitting on the sofa
    ![Girl sitting on the sofa](https://img.opennana.com/prompts/images/333.jpeg)
  ...
  ```
  ###
  full body night portrait
    ![full body night portrait](https://img.opennana.com/prompts/images/334.jpeg)
  ...
  ```
  ###
  Beautiful Japanese woman in light blue police uniform
    ![Beautiful Japanese woman in light blue police uniform](https://img.opennana.com/prompts/images/335.jpeg)
...
warm incandescent lighting with nostalgic amber tone, low saturation colors, fine 35mm film grain texture, slightly overexposed highlights, retro 1980s analog snapshot aesthetic, candid composition, shallow depth of field, cinematic color grading, in the style of Nobuyoshi Araki and Daido Moriyama street photography --ar 3:4 --v 7
  ```
  ###
  A dreamlike and intimate portrait
    ![A dreamlike and intimate portrait](https://img.opennana.com/prompts/images/336.jpeg)
  ...
  ```
  ###
  Girl with low ponytail in Japanese izakaya
    ![Girl with low ponytail in Japanese izakaya](https://img.opennana.com/prompts/images/337.jpeg)
  ...
  ```
  ###
  A huge vortex over the city breaks through the storm clouds
    ![A huge vortex over the city breaks through the storm clouds](https://img.opennana.com/prompts/images/338.jpeg)
  ...
  ```
  ###
  Beautiful girl in pleated mini skirt
    ![Beautiful girl in pleated mini skirt](https://img.opennana.com/prompts/images/339.jpeg)
  ...
  ```
  ###
  Photos of beautiful women taken with flash in an izakaya
    ![Photos of beautiful women taken with flash in an izakaya](https://img.opennana.com/prompts/images/340.jpeg)
...
The overall mood is nostalgic, warm, and faintly ambiguous — capturing a moment that feels real, close, and emotionally charged, like a personal memory illuminated by flash rather than a staged portrait.
  ```
  ###
  Photos of beautiful women in Tokyo subway stairwells
    ![Photos of beautiful women in Tokyo subway stairwells](https://img.opennana.com/prompts/images/341.jpeg)
...
The atmosphere is electric and nostalgic, a mix of youth, motion, and fleeting emotion, like a fragment from a fever dream or an afterimage burned into film — not cinematic, but hyper-real, the kind of moment only disposable-camera photography captures: alive, imperfect, and painfully real.
  ```
  ###
  A woman riding the subway
    ![A woman riding the subway](https://img.opennana.com/prompts/images/342.jpeg)
  ...
  ```
  ###
  Hyper-realistic studio portraits
    ![Hyper-realistic studio portraits](https://img.opennana.com/prompts/images/343.jpeg)

  ```markdown
  Hyper-realistic studio portrait of a man leaning elegantly on the back of a chair, wearing stylish dark clothing. Shot at a subtle low angle to highlight his facial features and confident expression. Movie-like black and white color palette, skin tone is natural and delicate. Pure black backgrounds, 8K sharp detail, highlight the texture of clothing, hair and eyes, creating a dramatic, lifelike effect.
  ```
  ###
  Mid-autumn moon swing photos
    ![Mid-autumn moon swing photos](https://img.opennana.com/prompts/images/344.jpeg)

  ```markdown
  Mid-autumn moon swing photos
  ```
  ###
  A retro-style selfie of you holding a baby version of yourself
    ![A retro-style selfie of you holding a baby version of yourself](https://img.opennana.com/prompts/images/345.jpeg)

  ```markdown
  retro selfies of you holding a baby version of you
  ```
  ###
  Characters and large Gengar
    ![Characters and large Gengar](https://img.opennana.com/prompts/images/346.jpeg)
  ...
  Characters and Pokémon
    ![Characters and Pokémon](https://img.opennana.com/prompts/images/347.jpeg)
  ...
  ```
  ###
  super mario style photos
    ![super mario style photos](https://img.opennana.com/prompts/images/348.jpeg)

  ```markdown
  Generate a picture, the character is wearing a red hat with a white circle and a red "M" logo on the hat; the upper body is red short-sleeved, the lower body is paired with blue overalls, there are yellow round decorative buttons on the pants, and the red socks are highly restored, and the props are rich and diverse.
  ```
  ###
  Retro Newsboy
    ![Retro Newsboy](https://img.opennana.com/prompts/images/349.jpeg)

  ```markdown
  Keep the character's facial features and posture unchanged to generate a fresh portrait: the character wears a beige short-sleeved shirt, green overalls, and a green retro newsboy cap. Wearing a small red scarf, a small green shoulder bag, and white socks. The background is changed to true red, with "Happy Day" written in English on the upper right side of the screen. The text blends into the surroundings of the characters, and the light is soft and even.
  ```
  ###
  Chinese red selfie photo
    ![Chinese red selfie photo](https://img.opennana.com/prompts/images/350.jpeg)

  ```markdown
  In the picture, the character has yellow flowers on both sides of his hair, a red five-pointed star pattern on his right cheek, gold earrings and a thin necklace, a red T-shirt with white "China" text printed on it, a solid red background, and exquisite makeup (red lips, natural eye makeup). The overall style is full of patriotic feelings, fresh and bright, and high-definition details.
  ```
  ###
  Patrick and Spongebob in ancient costumes
    ![Patrick and Spongebob in ancient costumes](https://img.opennana.com/prompts/images/351.png)

  ```markdown
  A big star wearing a Tang Dynasty costume is natural and lifelike. It is a dark brown old version of an oil painting in the style of the Northern Song Dynasty. It is a high-definition, fine and meticulous brushwork, fine and smooth, flexible and powerful, and full of rhythm. The outline of the clothing pattern is dense and dense. Elegant colors, good at using contrasting colors, rich and harmonious, wearing a Tang Dynasty hat
  ```
  ###
  Woman 3D digital illustration
    ![Woman 3D digital illustration](https://img.opennana.com/prompts/images/352.jpeg)
  ...
  ```
  ###
  Cinematic Surrealist Portraits
    ![Cinematic Surrealist Portraits](https://img.opennana.com/prompts/images/353.jpeg)
...
” written on it. Her fingers are slender, relaxed, and slightly curved. Her left arm is bent at the elbow, resting casually on the table. She wears a dark gray, slightly loose long-sleeve Henley top with the top buttons undone, subtly revealing a delicate neckline. Her hair falls naturally around her shoulders, soft waves catching the light. Her gaze is directed to the side, away from the camera, carrying a thoughtful and mysterious expression. The lighting is soft and moody, emphasizing the texture of her hair and face while adding cinematic contrast and emotional depth. The portrait is shot at eye level with an 85mm lens effect and a shallow depth of field, keeping her face and upper body in sharp focus while the background softly blurs. The overall color grading is muted and cinematic, with cool tones, soft shadows, and a minimalist dark background.
  ```
  ###
  Super detailed realistic portrait of beautiful woman
    ![Super detailed realistic portrait of beautiful woman](https://img.opennana.com/prompts/images/354.jpeg)
  ...
  ```
  ###
  Take selfies with Marvel characters
    ![Take selfies with Marvel characters](https://img.opennana.com/prompts/images/355.jpeg)
  ...
  ```
  ###
  Black and white style portrait
    ![Black and white style portrait](https://img.opennana.com/prompts/images/356.jpeg)
  ...
  ###
  Black and white style portrait
    ![Black and white style portrait](https://img.opennana.com/prompts/images/357.jpeg)
  ...
  Bedroom mirror selfie
    ![Bedroom mirror selfie](https://img.opennana.com/prompts/images/358.jpeg)
  ...
  ```
  ###
  red evening dress woman
    ![red evening dress woman](https://img.opennana.com/prompts/images/359.jpeg)
  ...
  ```
  ###
  Stylish woman posing with bear
    ![Stylish woman posing with bear](https://img.opennana.com/prompts/images/360.jpeg)
  ...
  ###
  Plush world
    ![Plush world](https://img.opennana.com/prompts/images/361.jpeg)
  ...
  ```
  ###
  Confident and elegant lady in black suit
    ![Confident and elegant lady in black suit](https://img.opennana.com/prompts/images/362.jpeg)
  ...
  ```
  ###
  Brand creative 3D advertising
    ![Brand creative 3D advertising](https://img.opennana.com/prompts/images/363.jpeg)
  ...
  ```
  ###
  Girls in pink camisole show their love
    ![Girls in pink camisole show their love](https://img.opennana.com/prompts/images/364.jpeg)
  ...
  ```
  ###
  A dramatic black and white studio portrait
    ![A dramatic black and white studio portrait](https://img.opennana.com/prompts/images/365.jpeg)

  ```markdown
  A dramatic black and white studio portrait. The subject stands with his back to the camera, his upper body slightly turned to the side, his head slightly lowered, and the side profile of his face partially visible. The expression is calm and introspective, creating a quiet, mysterious atmosphere.

Lighting: A strong side light that casts sharp contrast. A clean horizontal beam cuts across the background wall. Much of the image is in shadow, with an emphasis on silhouettes and outlines.
Atmosphere: minimalist, moody, cinematic, evoking a sense of elegance and solitude. The subject wears a dark jacket that blends in with the shadows, giving it a smooth, sleek fashion magazine look.
Composition: Shot with a full-frame camera, 85mm lens, f/1.8 large aperture to create a shallow depth of field effect, ISO 200, shutter speed 1/125 second. Medium shot composition (from waist to head), emphasizing silhouette, profile and posture.
Post-production: high-contrast black and white effects, soft tonal gradients, deep shadows, adding slight film grain to increase texture, and finally presenting a refined art magazine style.
  ```
  ###
  Cinematic side profile portrait of a young woman
    ![Cinematic side profile portrait of a young woman](https://img.opennana.com/prompts/images/366.jpeg)

  ```markdown
  A cinematic side profile portrait of a young woman, head tilted back, eyes closed, bathed in dramatic light.
She stood in front of a dark blue background, wearing a black blazer. A warm spotlight shines from the upper right corner, casting an orange halo around her face and neck, creating a strong contrast between the cool blue shadows and the warm highlights.
The entire composition emphasizes mood and atmosphere, with clean studio lighting, soft gradients, and a minimalist vibe. Images should be artistic, modern, and visually impactful, similar to the editorial photography style of a high-end magazine.
Camera angle: Side shot, slight elevation
Lighting: Dramatic studio lighting, strong contrast, blue backlight + warm spotlights
Lens: 85mm portrait lens, shallow depth of field
Atmosphere: Moody, cinematic, minimalist
  ```
  ###
  Fashion film portrait of a young woman
    ![Fashion film portrait of a young woman](https://img.opennana.com/prompts/images/367.jpeg)

  ```markdown
  Stylish, cinematic portrait of a young woman sitting on a modern chair, indoors. She is framed in a 3/4 perspective, with her body slightly tilted back and one arm casually draped over a chair, exuding a calm and confident aura. This woman has an oval face, a well-defined jawline, and a hairstyle that is exactly the same as the reference picture. She sported a stylish all-black outfit that included a dark turtleneck and structured blazer for a high-fashion editorial look.
Set against a smooth dark wall, the windows cast a striking geometric pattern of light and shadow, emitting a soft pinkish-purple glow that contrasts with the shadows. Colored light falls on the wall and subtly illuminates the edges of her hair and shoulders, enhancing the dramatic atmosphere. The overall lighting is moody and artistic, with soft shadows and cinematic contrast. Color grading emphasizes deep blacks, muted skin tones, and vivid pink highlights, creating a magazine cover-like aesthetic.
The subject is slightly off center. No text, logos or watermarks should appear on the final image.
  ```
  ###
  Studio portrait of woman sitting on chair
    ![Studio portrait of woman sitting on chair](https://img.opennana.com/prompts/images/368.jpeg)

  ```markdown
  Please take a photo in a photo studio using the female face from the attached photo.
The shooting angle is frontal, with a white studio background and a woman sitting on a chair.
She wore an all-white outfit: a white blazer, a white skirt, and white heels.
Elegant pose, chin resting on hand, holding a sprig of white rose.
The soft sunset window light casts on the studio walls.
  ```
  ###
  Capture stylish bathroom dressing area through mirror
    ![Capture stylish bathroom dressing area through mirror](https://img.opennana.com/prompts/images/369.jpeg)
  ...
  Surreal gothic rabbit studio portrait
    ![Surreal gothic rabbit studio portrait](https://img.opennana.com/prompts/images/370.jpeg)
...
"unrealistic skin", "plastic texture", "missing details"
  ...
  ```
  ###
  Highly detailed portraits of people as animals
    ![Highly detailed portraits of people as animals](https://img.opennana.com/prompts/images/371.jpeg)
  ...
  ###
  90s style photos
    ![90s style photos](https://img.opennana.com/prompts/images/372.jpeg)
  ...
  ```
  ###
  Portrait wearing a loose white shirt
    ![Portrait wearing a loose white shirt](https://img.opennana.com/prompts/images/373.jpeg)
...
The overall image is high-fashion editorial in monochrome, cinematic, and striking.
  ...
  Sitting next to a giant furry cute cartoon monster
    ![Sitting next to a giant furry cute cartoon monster](https://img.opennana.com/prompts/images/374.jpeg)
  ...
  ```
  ###
  An exquisite figural metal coin
    ![An exquisite figural metal coin](https://img.opennana.com/prompts/images/375.jpeg)
...
Person's face attached in the image ( Do not change facial features of the person from the uploaded photo. Keep face of person 100% accurate from the reference image. Keep the original face of the attached person unchanged and realistic)  embossed in profile, crafted with realistic engraved textures and fine relief detailing. The coin surface shows light reflections, scratches, and metallic sheen. Include subtle inscriptions or symbols around the border to resemble authentic minting. Centered on a dark, minimal background to emphasize the coin’s texture and realism
  ```
  ###
  Sitting on a huge smooth white rock formation
    ![Sitting on a huge smooth white rock formation](https://img.opennana.com/prompts/images/376.jpeg)
...
The overall atmosphere is calm, stylish, and Mediterranean-inspired. The face should match exactly with the reference photo.
  ```
  ###
  Sitting on a modern subway bench
    ![Sitting on a modern subway bench](https://img.opennana.com/prompts/images/377.jpeg)
...
Format: 2:3 Do not replace face; keep the same person with realistic proportions and lighting accuracy.
  ```
  ###
  Highest resolution photos of elegant poses
    ![Highest resolution photos of elegant poses](https://img.opennana.com/prompts/images/378.jpeg)
...
The image should look like a high-quality, ultra-realistic fashion magazine photo, keeping my real face exactly as shown in the reference photo.
  ...
  Wearing a newsboy cap and a black vest
    ![Wearing a newsboy cap and a black vest](https://img.opennana.com/prompts/images/379.jpeg)
...
He leans against a weathered brick wall in a narrow, atmospheric alleyway, looking upwards with a cool, contemplative expression through his round sunglasses. The lighting is moody and dramatic, with cool tones and soft shadows creating a sense of depth and mystery. The photograph is ultra-detailed with sharp focus and a shallow depth of field.
  ...
  cartoon illustration
    ![cartoon illustration](https://img.opennana.com/prompts/images/380.jpeg)
...
Keywords: hybrid photo-doodle, product cartoon, expressive characters, minimal pastel background. Aspect ratio: 1:1
  ```
  ###
  A luxurious high fashion portrait
    ![A luxurious high fashion portrait](https://img.opennana.com/prompts/images/381.jpeg)

  ```markdown
  A sumptuous high fashion portrait, [Character Description] sits elegantly on the lower edge of a large ornately decorated rectangular frame

Frame details:
• Baroque/Rococo style rectangular picture frame
• Paint with [frame color and texture] to harmonize with the overall tone

Environment:
• Background: Elegant studio wall, classic paneling [color]
• Floor: slightly reflective, [floor color]

Lighting:
• Cinematic high-key fashion lighting
• Soft and diffuse light on the subject
• Slight contour separation

Camera:
• Symmetrically centered full-length portrait
• Clean editorial stylish composition
• 8K ultra-clear high-end blockbuster quality

Style Tags: Monochrome | Floating Frame | Film Studio Fashion | Luxurious Editorial Aesthetics
  ```
  ###
  3D chibi style vinyl collectibles
    ![3D chibi style vinyl collectibles](https://img.opennana.com/prompts/images/382.jpeg)
...
Style: vinyl-toy aesthetic with a mix of matte + glossy accents depending on costume, Composition: 3/4 product shot view, full box visible. The entire packaging box must be fully visible inside the frame with a clean margin around all edges.
  ```
  ###
  A surreal macro photo
    ![A surreal macro photo](https://img.opennana.com/prompts/images/383.jpeg)
  ...
  ```
  ###
  Three views of people and cars
    ![Three views of people and cars](https://img.opennana.com/prompts/images/384.jpeg)
...
Style: Cinematic automotive editorial, urban setting, moody and stylish, professional fashion-meets- car photography, same face.
  ```
  ###
  A dramatic black and white close-up portrait
    ![A dramatic black and white close-up portrait](https://img.opennana.com/prompts/images/385.jpeg)

  ```markdown
  A dramatic black and white close-up portrait of a handsome young East Asian man. His hair was slightly damp and messy, sticking to his forehead and cheeks, with a few drops of water hanging on his cheeks. His eyes were blurry, his lips were slightly open, and there was a hint of vulnerability and temptation in his expression. He wore a water-soaked black T-shirt that clung to his shoulders. The strong side light illuminates the water droplets and moist skin on his face, creating sharp highlights that contrast sharply with the deep shadows. With a minimalist dark background, the photo has a cinematic atmosphere, high details, and heavy film grain, conveying a mysterious and tense emotion.
  ```
  ###
  Light peach pink loose plush pajamas for girls
    ![Light peach pink loose plush pajamas for girls](https://img.opennana.com/prompts/images/386.jpeg)
  ...
  ```
  ###
  Girl holding retro silver microphone
    ![Girl holding retro silver microphone](https://img.opennana.com/prompts/images/387.jpeg)
...
"scene": {
  ...
  Sleepy girl on white pillow
    ![Sleepy girl on white pillow](https://img.opennana.com/prompts/images/388.jpeg)
  ...
  ```
  ###
  Twin ponytails show love to girls
    ![Twin ponytails show love to girls](https://img.opennana.com/prompts/images/389.jpeg)
  ...
  ```
  ###
  Girls with rainbow hair styles
    ![Girls with rainbow hair styles](https://img.opennana.com/prompts/images/390.jpeg)
  ...
  Girls indoors in cafe
    ![Girls indoors in cafe](https://img.opennana.com/prompts/images/391.jpeg)
  ...
  Girls changing clothes
    ![Girls changing clothes](https://img.opennana.com/prompts/images/392.jpeg)
  ...
  Full body realistic fashion portrait
    ![Full body realistic fashion portrait](https://img.opennana.com/prompts/images/393.jpeg)
 ...
 "subject": {
  ...
  ```
  ###
  Taking a photo with Sonic Mario
    ![Taking a photo with Sonic Mario](https://img.opennana.com/prompts/images/394.jpeg)
  ...
  ```
  ###
  Cyber ​​aesthetics future social software interface photos
    ![Cyber ​​aesthetics future social software interface photos](https://img.opennana.com/prompts/images/395.jpeg)

  ```markdown
  A 9:16 vertical photo of a realistic cyber-aesthetic future social software interface: a hand holding a vertical translucent acrylic card, occupying most of the screen. It shows a social media profile interface without any banner or background image. The card has smooth, rounded edges and glows with soft neon lights in gradients of pink, purple and blue. The background is dark and blurred to highlight the glowing edges. The surface of the card is as clear as crystal, and the details of the personal data seem to be carved. Only the information in the reference picture is displayed, in order:
- Avatar (centered)
- Username, authentication badge at the top
- Personal introduction
- Location, website
- Date of joining
- Number of followers and number of followers
- Follow button
The light reflections on the fingers look cinematic and atmospheric, creating a high-tech holographic atmosphere.
  ```
  ###
  Create a 3D Twitter profile card
    ![Create a 3D Twitter profile card](https://img.opennana.com/prompts/images/396.jpeg)
...
Create a hyper-realistic 3D render of a transparent twitter profile card, designed like a futuristic glass ID badge held gently between two fingers. The card should be rectangular with rounded corners, made of clear glossy glass or acrylic, with glowing neon edges in pink, purple, and orange gradient inspired by the twitter color palette. Display the following profile information on the card using modern, minimal sans-serif typography.
  ```
  ###
  A candid photo of a young woman
    ![A candid photo of a young woman](https://img.opennana.com/prompts/images/397.jpeg)
  ...
  ```
  ###
  Studio photoshoot with oversized props
    ![Studio photoshoot with oversized props](https://img.opennana.com/prompts/images/398.jpeg)
  ...
  Young East Asian Female K-Pop Idol Style
    ![Young East Asian Female K-Pop Idol Style](https://img.opennana.com/prompts/images/399.jpeg)
  ...
  ```
  ###
  A candid photo of a young woman hiking in the mountains
    ![A candid photo of a young woman hiking in the mountains](https://img.opennana.com/prompts/images/400.jpeg)
  ...
  ```
  ###
  Close-up portrait of young woman wearing dark hoodie
    ![Close-up portrait of young woman wearing dark hoodie](https://img.opennana.com/prompts/images/401.jpeg)
  ...
  Digital comics of a middle-aged man
    ![Digital comics of a middle-aged man](https://img.opennana.com/prompts/images/402.jpeg)
...
The art style should combine semi-realistic digital painting with the texture of oil brushstrokes, delivering a balanced fusion of realism and stylized charm.Clean outlines, smooth blending, and controlled highlights give the impression of a modern portrait illustration—detailed, expressive, and visually captivating.
  ```
  ###
  A hyper-realistic, detailed underwater close-up portrait
    ![A hyper-realistic, detailed underwater close-up portrait](https://img.opennana.com/prompts/images/403.jpeg)
  ...
  Small and cute isometric view
    ![Small and cute isometric view](https://img.opennana.com/prompts/images/404.jpeg)
  ...
  ```
  ###
  Ultra-realistic full-body portraits and character interactions
    ![Ultra-realistic full-body portraits and character interactions](https://img.opennana.com/prompts/images/405.jpeg)
...
Expression and mood: {emotional tone}, captured in photorealistic textures, realistic lighting, cinematic composition, high fashion editorial quality.
  ```
  ###
  A hyper-realistic full-body portrait interacting with Luffy
    ![A hyper-realistic full-body portrait interacting with Luffy](https://img.opennana.com/prompts/images/406.jpeg)
  ...
  ```
  ###
  Turn celebrities into fun 3D cartoon portraits
    ![Turn celebrities into fun 3D cartoon portraits](https://img.opennana.com/prompts/images/407.jpeg)
  ...
  ```
  ###
  The character becomes a 3D collectible Q-version doll
    ![The character becomes a 3D collectible Q-version doll](https://img.opennana.com/prompts/images/408.jpeg)
  ...
  ```
  ###
  Branded 3D rendering of large capsule-shaped container
    ![Branded 3D rendering of large capsule-shaped container](https://img.opennana.com/prompts/images/409.jpeg)
  ...
  ```
  ###
  Selfie style photo surrounded by several animals
    ![Selfie style photo surrounded by several animals](https://img.opennana.com/prompts/images/410.jpeg)
  ...
  A woman walks out of the smartphone screen
    ![A woman walks out of the smartphone screen](https://img.opennana.com/prompts/images/411.jpeg)
  ...
  ###
  3D comic portrait
    ![3D comic portrait](https://img.opennana.com/prompts/images/412.jpeg)
  ...
  ```
  ###
  Pencil style big head cartoon
    ![Pencil style big head cartoon](https://img.opennana.com/prompts/images/413.jpeg)
...
"a big head caricature." Ensure to create an image with a noticeably exaggerated head size for the caricature effect you desire, while retaining the charcoal and brush stroke style"
  ...
  ```
  ###
  3x3 photo in clean soft beige studio
    ![3x3 photo in clean soft beige studio](https://img.opennana.com/prompts/images/414.jpeg)
  ...
  ```
  ###
  Nine Q-version stickers with different clothing poses and expressions
    ![Nine Q-version stickers with different clothing poses and expressions](https://img.opennana.com/prompts/images/415.jpeg)
  ...
  ```
  ###
  Exaggerated HD full body comics
    ![Exaggerated HD full body comics](https://img.opennana.com/prompts/images/416.jpeg)
  ...
  ```
  ###
  A hyper-realistic, high-quality close-up portrait
    ![A hyper-realistic, high-quality close-up portrait](https://img.opennana.com/prompts/images/417.jpeg)
...
Create an hyperrealistic and high quality close-up portrait of a styling young woman,  her dark thick long hair styled in twin high artistic braids that falls over her ears, few loose trendils clipped using a different style matte brown statement hair clips ,with few loose strands falls across and frames her face, wearing a drawstring halter top, a thick-frame  brown cat-eye eyeglasses slightly lowered, soft hazel nut eyes, glossy red pouty lips, peached dewy blush and soft warm tone eyeshadows with a little bit shimmers and glitters on her cheeks and under her eyes, artistic brown eyeliner, natural dewy skin, head slightly tilted, relaxed and confident gaze hand-on-cheek pose, minimalistic background, warm beige and brown tones, bright and harsh illumination coming from the camera highlighting the texture of her figure, soft studio background lighting, K-fashion editorial aesthetic, Seoul street style influence, hyper-detailed face texture, cinematic tone, 85mm lens photography, Vogue Korea vibe, stylish and modern mood --ar 2:3 --v 6 --style raw --q 2 --s 250
  ...
  Redesign movie posters into claymation style
    ![Redesign movie posters into claymation style](https://img.opennana.com/prompts/images/418.jpeg)
  ...
  Young woman by the window on the bus
    ![Young woman by the window on the bus](https://img.opennana.com/prompts/images/419.jpeg)
  ...
  Light and shadow triptych at home
    ![Light and shadow triptych at home](https://img.opennana.com/prompts/images/420.jpeg)
...
The figure wears a light gray-blue halter top with slender shoulder straps. The fabric is soft and close-fitting, reflecting a soft luster. Creates a soft highlight in the light, emphasizing curved lines. The colors and background remain consistent with low saturation, and the picture appears clean.
...
--- ## 🔗 References
  ...
  - [GitHub - fluxcd/flux: Successor: https://github.com/fluxcd/flux2](https://github.com/fluxcd/flux)
